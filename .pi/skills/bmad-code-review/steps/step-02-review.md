...
4. Collect all findings from the completed layers. If reviewer output files or manual command transcripts are persisted for a known story, ensure `{review_artifact_dir}` is `{implementation_artifacts}/{story_key}`, create `{review_artifact_dir}/{{story_id_dash}}-reviews` if needed, and write raw layer outputs there using the current review round when known, e.g. `{{story_id_dash}}-reviews/{{story_id_dash}}-R<number>-blind-hunter.md`, `{{story_id_dash}}-reviews/{{story_id_dash}}-R<number>-edge-case-hunter.md`, and `{{story_id_dash}}-reviews/{{story_id_dash}}-R<number>-acceptance-auditor.md`. In `/dev-cycle` reviewer A/B mode, use `{{story_id_dash}}-reviews/{{story_id_dash}}-R<number>-reviewer-a.md` and `{{story_id_dash}}-reviews/{{story_id_dash}}-R<number>-reviewer-b.md`. Do not write story-specific review artifacts directly at the implementation-artifacts root.
